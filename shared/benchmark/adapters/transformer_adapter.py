...
Reuses the HybridPredictor + validator from competition/participant-files/make_eval_predictions.py, but
...
Usage (from repo root):
  python shared/benchmark/adapters/transformer_adapter.py \
      --eval-set shared/benchmark/eval_set_v1 \
      --out shared/benchmark/predictions/ssl_transformer \
...
MEP_PATH = ROOT / "competition" / "participant-files" / "make_eval_predictions.py"
...
def main():
    ...
    ap.add_argument("--out", default="shared/benchmark/predictions/ssl_transformer")
