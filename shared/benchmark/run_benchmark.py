...
def main():
    ...
    ap.add_argument("--pred-root", default="shared/benchmark/predictions")
    ap.add_argument("--gt-dir", default="shared/benchmark/eval_set_v1/ground_truth")
    ...
    if not models:
        raise SystemExit(f"No model folders under {pred_root}. See shared/benchmark/README.md.")
