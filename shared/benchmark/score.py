...
Reuses the official metric implementations from competition/participant-files/eval_metrics.py so the
...
EVAL_METRICS = ROOT / "competition" / "participant-files" / "eval_metrics.py"
