...
Outputs:
  shared/extras/eda/stats.json        — machine-readable summary
  shared/extras/eda/stats.md          — human-readable summary (markdown)
  shared/extras/eda/*.png             — plots
"""
...
DATA = REPO / "competition" / "track-details" / "training_data"
OUT = REPO / "shared" / "extras" / "eda"
