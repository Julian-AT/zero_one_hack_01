# Eval — shared/extras/checkpoints/v2-transformer-small-lm_only-held_mosfet/final.pt

## Next-step + completion (held-out per family)
| family | frac | Top-1@cut | Top-5@cut | ExactMatch | NED |
|---|---|--:|--:|--:|--:|
| MOSFET | 0.6 | 0.8167 | 1.0000 | 0.0000 | 0.4229 |
| MOSFET | 0.8 | 0.4167 | 1.0000 | 0.0000 | 0.4762 |
