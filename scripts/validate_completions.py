...
Usage:
    .venv/bin/python scripts/validate_completions.py \\
        --eval-input  participant_files/eval_input_valid.csv \\
        --predictions extras/results/submission_v2_real/completion.csv
"""
...
def main() -> None:
    ...
    ap.add_argument("--eval-input", default="participant_files/eval_input_valid.csv")
