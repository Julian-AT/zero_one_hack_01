...
Reads every run under extras/logs/tb/, parses LoFO/final cell ids, and
produces a set of overview PNGs in extras/plots/training/:
...
TB_DIR = REPO_ROOT / "extras" / "logs" / "tb"
CKPT_DIR = REPO_ROOT / "extras" / "checkpoints"
OUT_DIR = REPO_ROOT / "extras" / "plots" / "training"
