...
<!-- BEGIN_INTERNAL_RERANKER_BENCHMARK -->

---

## Internal Reranker Benchmark

We evaluated the rule-aware next-step reranker on the internal labeled test split to check whether reranking improves or hurts the base SSL model. This is not the hidden organizer evaluation; it is an internal sanity check using our generated labeled test data.
...
<!-- END_INTERNAL_RERANKER_BENCHMARK -->
