...
def main() -> None:
    ...
    parser.add_argument("--valid-input", default="extras/results/eval_inputs/eval_input_valid.csv")
    parser.add_argument(
        "--anomaly-input", default="extras/results/eval_inputs/eval_input_anomaly.csv"
    )
