...
CLI:
  python -m src.experiments.lofo_grid --list        # print id+overrides per cell
  python -m src.experiments.lofo_grid --count       # number of cells
  python -m src.experiments.lofo_grid --cell N      # print launch args for cell N
  python -m src.experiments.lofo_grid --eval-cell N # print eval args for cell N
"""
...
def _eval_args(cell: Cell) -> List[str]:
    """Args for `python -m src.eval.run_eval`."""
    out = [
