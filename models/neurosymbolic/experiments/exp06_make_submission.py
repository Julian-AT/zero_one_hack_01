...
Run
---
    PYTHONPATH=models/neurosymbolic python3 \
        models/neurosymbolic/experiments/exp06_make_submission.py [flags]
...
output directory; otherwise ``$NSPE_OUT`` or ``models/neurosymbolic/outputs``).
"""
...
def _default_out_dir() -> Path:
    """Output dir: env ``NSPE_OUT`` else ``models/neurosymbolic/outputs``."""
