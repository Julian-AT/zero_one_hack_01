...
CLI:
    python -m transformer_xlstm.data.physics              # build lookup, save to data/processed/
    python -m transformer_xlstm.data.physics --inspect    # print a few examples
"""
...
from transformer_xlstm.utils.paths import FAMILY_PARAM_FILES, RAW_DATA_DIR
