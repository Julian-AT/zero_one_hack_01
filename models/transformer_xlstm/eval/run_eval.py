...
Outputs a JSON + Markdown report under `shared/extras/results/eval/<run_name>/`.

Usage on Leonardo:
  pixi run python -m transformer_xlstm.eval.run_eval \
      --checkpoint shared/extras/checkpoints/cell1-transformer_medium-compositional/final.pt \
      --output-dir shared/extras/results/eval/cell1
"""
...
from transformer_xlstm.eval.metrics import normalized_edit_distance
