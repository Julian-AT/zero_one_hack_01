...
from transformer_xlstm.data.validator import RULE_IDS
...
def main() -> None:
    ...
    parser.add_argument("--submission-dir", default="shared/extras/results/submission")
    parser.add_argument("--eval-inputs-dir", default="shared/extras/results/eval_inputs")
