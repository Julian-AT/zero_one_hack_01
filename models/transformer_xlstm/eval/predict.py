...
scoring — usable with any checkpoint produced by `transformer_xlstm.train.trainer`.

Designed to run on Leonardo compute nodes where torch + the checkpoints
live. The functions here are imported by `transformer_xlstm.eval.run_eval` (the CLI).
"""
...
from transformer_xlstm.data.tokenizer import BaseTokenizer, build_tokenizer
