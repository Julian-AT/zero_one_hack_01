...
|---|---|---|---|--:|---|--:|--:|--:|--:|--:|--:|--:|
| `lofo-xlstm-small-lm_only-fdp02-held_igbt` | xlstm | small | lm_only | 0.2 | igbt | 1731344 | 0.7250 | 0.9850 | 0.4754 | 0.6125 | -0.1125 | 1.0000 |
| `lofo-xlstm-small-lm_only-fdp00-held_igbt` | xlstm | small | lm_only | 0.0 | igbt | 1731344 | 0.7150 | 0.9800 | 0.4924 | 0.6075 | -0.1075 | 1.0000 |
| `lofo-xlstm-medium-lm_only-fdp00-held_igbt` | xlstm | medium | lm_only | 0.0 | igbt | 12051008 | 0.6950 | 0.9850 | 0.4207 | 0.6050 | -0.0900 | 1.0000 |
...
| `lofo-transformer-medium-multitask-fdp02-held_igbt` | transformer | medium | multitask | 0.2 | igbt | 34177548 | 0.6800 | 0.9850 | 0.6440 | 0.6150 | -0.0650 | 1.0000 |
| `lofo-xlstm-small-multitask-fdp02-held_igbt` | xlstm | small | multitask | 0.2 | igbt | 1866012 | 0.6800 | 0.9850 | 0.5078 | 0.6150 | -0.0650 | 0.0000 |
| `lofo-xlstm-medium-lm_only-fdp02-held_igbt` | xlstm | medium | lm_only | 0.2 | igbt | 12051008 | 0.6750 | 0.9850 | 0.4182 | 0.6200 | -0.0550 | 1.0000 |
...
| `lofo-xlstm-small-multitask-fdp00-held_igbt` | xlstm | small | multitask | 0.0 | igbt | 1866012 | 0.6650 | 0.9800 | 0.5390 | 0.5950 | -0.0700 | 0.0000 |
| `lofo-xlstm-medium-multitask-fdp00-held_igbt` | xlstm | medium | multitask | 0.0 | igbt | 12582476 | 0.6600 | 0.9800 | 0.4188 | 0.6000 | -0.0600 | 0.2000 |
...
| `lofo-xlstm-medium-lm_only-fdp00-held_ic` | xlstm | medium | lm_only | 0.0 | ic | 12051008 | 0.5900 | 0.9750 | 0.5464 | 0.4850 | -0.1050 | 1.0000 |
...
| `lofo-xlstm-medium-lm_only-fdp02-held_ic` | xlstm | medium | lm_only | 0.2 | ic | 12051008 | 0.5750 | 0.9750 | 0.5694 | 0.5500 | -0.0250 | 1.0000 |
| `lofo-xlstm-small-lm_only-fdp02-held_mosfet` | xlstm | small | lm_only | 0.2 | mosfet | 1731344 | 0.5750 | 0.9450 | 0.5999 | 0.6075 | 0.0325 | 1.0000 |
| `lofo-xlstm-small-multitask-fdp00-held_mosfet` | xlstm | small | multitask | 0.0 | mosfet | 1866012 | 0.5700 | 1.0000 | 0.7465 | 0.6275 | 0.0575 | 1.0000 |
| `lofo-xlstm-small-lm_only-fdp02-held_ic` | xlstm | small | lm_only | 0.2 | ic | 1731344 | 0.5650 | 0.9750 | 0.5467 | 0.6175 | 0.0525 | 1.0000 |
...
| `lofo-xlstm-small-lm_only-fdp00-held_ic` | xlstm | small | lm_only | 0.0 | ic | 1731344 | 0.5600 | 0.9750 | 0.5480 | 0.6125 | 0.0525 | 1.0000 |
| `lofo-xlstm-small-multitask-fdp02-held_mosfet` | xlstm | small | multitask | 0.2 | mosfet | 1866012 | 0.5500 | 0.9850 | 0.7214 | 0.6325 | 0.0825 | 1.0000 |
| `lofo-xlstm-small-lm_only-fdp00-held_mosfet` | xlstm | small | lm_only | 0.0 | mosfet | 1731344 | 0.5450 | 0.9500 | 0.5691 | 0.6375 | 0.0925 | 1.0000 |
...
| `lofo-transformer-medium-multitask-fdp02-held_ic` | transformer | medium | multitask | 0.2 | ic | 34177548 | 0.5250 | 0.9600 | 0.6611 | 0.5825 | 0.0575 | 1.0000 |
| `lofo-xlstm-medium-lm_only-fdp02-held_mosfet` | xlstm | medium | lm_only | 0.2 | mosfet | 12051008 | 0.5250 | 0.9550 | 0.5095 | 0.6525 | 0.1275 | 1.0000 |
...
| `lofo-xlstm-medium-lm_only-fdp00-held_mosfet` | xlstm | medium | lm_only | 0.0 | mosfet | 12051008 | 0.5200 | 0.9550 | 0.4979 | 0.6075 | 0.0875 | 1.0000 |
| `lofo-xlstm-medium-multitask-fdp00-held_mosfet` | xlstm | medium | multitask | 0.0 | mosfet | 12582476 | 0.5200 | 0.9550 | 0.5181 | 0.6625 | 0.1425 | 1.0000 |
| `lofo-xlstm-small-multitask-fdp00-held_ic` | xlstm | small | multitask | 0.0 | ic | 1866012 | 0.5200 | 0.9750 | 0.5534 | 0.6050 | 0.0850 | 1.0000 |
| `lofo-xlstm-small-multitask-fdp02-held_ic` | xlstm | small | multitask | 0.2 | ic | 1866012 | 0.5100 | 0.9750 | 0.5530 | 0.6350 | 0.1250 | 1.0000 |
...
|---|---|---|--:|--:|--:|--:|
| xlstm | small | lm_only | 0.2 | 0.6217 | -0.0092 | 1.0000 |
| xlstm | small | lm_only | 0.0 | 0.6067 | 0.0125 | 1.0000 |
| transformer | medium | multitask | 0.2 | 0.6025 | -0.0037 | 1.0000 |
| xlstm | medium | lm_only | 0.0 | 0.6017 | -0.0358 | 1.0000 |
| transformer | small | multitask | 0.2 | 0.5983 | 0.0225 | 1.0000 |
| transformer | small | multitask | 0.0 | 0.5950 | -0.0300 | 1.0000 |
| xlstm | medium | lm_only | 0.2 | 0.5917 | 0.0158 | 1.0000 |
| xlstm | medium | multitask | 0.0 | 0.5900 | 0.0413 | 0.6000 |
| xlstm | small | multitask | 0.0 | 0.5850 | 0.0242 | 0.6667 |
| transformer | small | lm_only | 0.2 | 0.5817 | 0.0175 | 1.0000 |
| xlstm | small | multitask | 0.2 | 0.5800 | 0.0475 | 0.6667 |
