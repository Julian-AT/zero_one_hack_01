...
Example:
    python competition/track-details/scripts/train_ssl_hybrid_process_transformer.py \
      --data competition/track-details/data/generated/valid_long_augmented.csv \
      --out-dir competition/track-details/runs/ssl_hybrid_augmented_smoke \
      --max-sequences 3000 \
      --epochs 2 \
      --batch-size 64 \
      --d-model 128 \
