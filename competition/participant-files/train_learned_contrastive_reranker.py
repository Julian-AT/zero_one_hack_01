...
Outputs:
  ...
  competition/participant-files/predictions/learned_reranker.pt
"""
...
from transformer_xlstm.data.sequence_io import norm, read_csv  # noqa: E402
from transformer_xlstm.eval.metrics import reciprocal_rank  # noqa: E402
...
PRED_MOD_PATH = ROOT / "competition" / "participant-files" / "make_eval_predictions.py"
RERANK_MOD_PATH = ROOT / "competition" / "participant-files" / "rerank_nextstep_with_rules.py"
